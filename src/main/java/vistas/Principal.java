...
public class Principal {
    ...
    private void initialize() {
        ...
        btnExportStats.addActionListener(e -> {
            ...
            fileChooser.setDialogTitle("Guardar estad�sticas");
            int userSelection = fileChooser.showSaveDialog(frame);

            if (userSelection == JFileChooser.APPROVE_OPTION) {
                String ruta = fileChooser.getSelectedFile().getAbsolutePath();
                controlador.exportarEstadisticas(ruta);
                JOptionPane.showMessageDialog(frame, "Estad�sticas exportadas con �xito", "�xito", JOptionPane.INFORMATION_MESSAGE);
            }
        });
        ...
        btnImport.addActionListener(e -> {
            ...
            JOptionPane.showMessageDialog(frame, "Cursos importados correctamente", "Importaci�n", JOptionPane.INFORMATION_MESSAGE);
        });
        ...
        btnIniciar.addActionListener(e -> {
            try {
                if (courseList.getSelectedValue() != null) {
                    ...
                    Configuracion.mostrarDialogo(); // La config ya har� el resto
                } else {
